...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('user', (
            ...
            ('token', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True, null=True)),
    ...
    models = {
        'account.user': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True', 'null': 'True'})
        }
    }
